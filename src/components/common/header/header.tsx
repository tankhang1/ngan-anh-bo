										...
										<div className="mt-3">
											...
											<ul className="ps-2">
												<li className="p-1 d-flex align-items-center text-muted mb-2 search-app">
													<Link to={`${import.meta.env.BASE_URL}apps/fullcalendar`}><span><i className="bx bx-calendar me-2 fs-14 bg-primary-transparent p-2 rounded-circle"></i>Calendar</span></Link>
												</li>
												<li className="p-1 d-flex align-items-center text-muted mb-2 search-app">
													<Link to={`${import.meta.env.BASE_URL}pages/email/mailapp`}><span><i className="bx bx-envelope me-2 fs-14 bg-primary-transparent p-2 rounded-circle"></i>Mail</span></Link>
												</li>
												<li className="p-1 d-flex align-items-center text-muted mb-2 search-app">
													<Link to={`${import.meta.env.BASE_URL}uielements/buttons`}><span><i className="bx bx-dice-1 me-2 fs-14 bg-primary-transparent p-2 rounded-circle"></i>Buttons</span></Link>
												</li>
											</ul>
										</div>
										<div className="mt-3">
							...
							<Dropdown.Menu align="end" className="main-header-dropdown dropdown-menu  border-0 dropdown-menu-end" data-popper-placement="none">
								...
								<div className={`p-3 empty-header-item border-top ${cartItemCount === 0 ? "d-none" : "d-block"}`}>
									<div className="d-grid">
										<Link to={`${import.meta.env.BASE_URL}pages/ecommerce/checkout`} className="btn btn-primary">Checkout</Link>
									</div>
								</div>
											...
											<Dropdown.Item as="li" key={index}>
												<div className="d-flex align-items-start">
													...
													<div className="flex-grow-1 d-flex  justify-content-between">
														<div>
															<p className="mb-0 fw-semibold"><Link to={`${import.meta.env.BASE_URL}pages/notifications`}>{notification.name}</Link> <span className="text-warning">{notification.text2}</span></p>
						...
						<Dropdown className="header-element mainuserProfile">
							...
							<Dropdown.Menu as="ul" className="dropdown-menu  border-0 main-header-dropdown  overflow-hidden header-profile-dropdown" aria-labelledby="mainHeaderProfile">
								<Dropdown.Item as="li" className="border-0">
									<Link to={`${import.meta.env.BASE_URL}pages/profile`}><i className="fs-13 me-2 bx bx-user"></i>Profile</Link></Dropdown.Item>
								<Dropdown.Item as="li" className="border-0">
									<Link to={`${import.meta.env.BASE_URL}pages/email/mailapp`}>
								...
								<Dropdown.Item as="li" className="border-0">
									<Link to={`${import.meta.env.BASE_URL}authentication/signin/signincover1`}>
							...
							<Tab.Pane eventKey="first" className="" id="orders-1" role="tabpanel">
								...
								<ul className="ps-0 vertical-scroll">
									<li className="item">
										<div className="rounded-2 p-3 border mb-2">
											<div className="d-flex">
												<Link to={`${import.meta.env.BASE_URL}pages/profile`}><img src={faces16} alt="img"
									...
									<li className="item">
										<div className="rounded-2 p-3 border mb-2">
											<div className="d-flex">
												<Link to={`${import.meta.env.BASE_URL}pages/profile`}><span
									...
									<li className="item">
										<div className="rounded-2 p-3 border mb-2">
											<div className="d-flex">
												<Link to={`${import.meta.env.BASE_URL}pages/profile`}><img src={faces6} alt="img"
													className="avatar avatar-md rounded-2 me-3" /></Link>
												<div className="me-3">
													<Link to={`${import.meta.env.BASE_URL}pages/profile`}>
									...
									<li className="item">
										<div className="rounded-2 p-3 border mb-2">
											<div className="d-flex">
												<Link to={`${import.meta.env.BASE_URL}pages/profile`}><img src={faces9} alt="img"
													className="avatar avatar-md rounded-2 me-3" /></Link>
												<div className="me-3">
													<Link to={`${import.meta.env.BASE_URL}pages/profile`}>
							...
							<Tab.Pane eventKey="second" className="" id="accepted-1" role="tabpanel">
								<ul className="activity-list">
									<li className="d-flex mt-4">
										<div>
											<i className="activity-icon">
												<Link to={`${import.meta.env.BASE_URL}pages/profile`}><img src={faces14} alt="img"
									...
									<li className="d-flex mt-4">
										<div>
											<i className="activity-icon">
												<Link to={`${import.meta.env.BASE_URL}pages/profile`}><img src={faces11} alt="img"
													className="avatar avatar-xs rounded-2 me-3" /></Link>
											</i>
											<Link to={`${import.meta.env.BASE_URL}pages/profile`}>
									...
									<li className="d-flex mt-4">
										<div>
											...
											<div className="activity-images mt-3">
												<Link to={`${import.meta.env.BASE_URL}apps/gallery`}><img src={media34} alt="thumb1" /></Link>
												<Link to={`${import.meta.env.BASE_URL}apps/gallery`}><img src={media35} alt="thumb1" /></Link>
												<Link to={`${import.meta.env.BASE_URL}apps/gallery`}><img src={media36} alt="thumb1" /></Link>
											</div>
										</div>
									</li>
									<li className="d-flex mt-4">
