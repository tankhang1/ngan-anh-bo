  ...
  useEffect(() => {
    ...
    return () => {
      ThemeChanger({
        ...
        dataNavStyle: "",
        dataNavLayout: `${
          localStorage.velvetlayout == "horizontal" ? "horizontal" : "vertical"
        }`,
      });
    };
  }, [theme]);
            ...
            <div className="d-flex align-items-center switcher-style flex-wrap">
              <div className="form-check switch-select me-3">
                <input
                  ...
                  type="radio"
                  checked={local_varaiable.colorPrimaryRgb == "13, 73, 159"}
                  onChange={(_e) => {}}
              ...
              <div className="form-check switch-select me-3">
                <input
                  ...
                  type="radio"
                  checked={local_varaiable.colorPrimaryRgb == "0, 128, 172"}
                  onChange={(_e) => {}}
              ...
              <div className="form-check switch-select me-3">
                <input
                  ...
                  type="radio"
                  name="theme-primary"
                  checked={local_varaiable.colorPrimaryRgb == "100, 48, 124"}
                  onChange={(_e) => {}}
              ...
              <div className="form-check switch-select me-3">
                <input
                  ...
                  type="radio"
                  name="theme-primary"
                  checked={local_varaiable.colorPrimaryRgb == "5, 154, 114"}
                  onChange={(_e) => {}}
              ...
              <div className="form-check switch-select me-3">
                <input
                  ...
                  type="radio"
                  name="theme-primary"
                  checked={local_varaiable.colorPrimaryRgb == "177, 90, 17"}
                  onChange={(_e) => {}}
