...
export const HorizontalClick = (actionfunction: ActionFunction) => {
  ...
  actionfunction({
    ...
    dataMenuStyles: localStorage.velvetdarktheme
      ? "dark"
      : localStorage.darkBgRGB1
      ? "dark"
      : localStorage.velvetMenu
      ? localStorage.velvetMenu
      : "gradient",
    dataVerticalStyle: "",
    dataNavStyle: localStorage.velvetnavstyles
      ? localStorage.velvetnavstyles
      : "menu-click",
  });
...
export const LocalStorageBackup = (actionfunction: any) => {
  ...
  localStorage.velvetheaderscrollable
  ...
  localStorage.velvetnavstyles === "menu-click"
    ? Menuclick(actionfunction)
    : "";
  localStorage.velvetnavstyles === "menu-hover"
    ? MenuHover(actionfunction)
    : "";
  localStorage.velvetnavstyles === "icon-click"
    ? IconClick(actionfunction)
    : "";
  localStorage.velvetnavstyles === "icon-hover"
  ...
  if (localStorage.darkBgRGB1) {
    ...
    actionfunction({
      ...
      dataThemeMode: "dark",
      dataHeaderStyles: localStorage.velvetHeader
        ? localStorage.velvetHeader
        : localStorage.velvetdarktheme
        ? "dark"
        : "dark",
      dataMenuStyles: "dark",
    });
