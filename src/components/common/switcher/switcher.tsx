                  ...
                  <div className="row switcher-style gx-0">
                    ...
                    <div className="col-4 rounded-header">
                      <div className="form-check switch-select">
                        <label
                          className="form-check-label"
                          htmlFor="switcher-header-rounded"
                        >
                          Rounded
                        </label>
                        <input
                          ...
                          name="header-positions"
                          checked={
                            local_varaiable.dataHeaderPosition == "rounded"
                          }
                          onChange={(_e) => {}}
                          onClick={() =>
                            switcherdata.Headerpostionrounded(ThemeChanger)
                          }
                  ...
                  <div className="theme-colors">
                    ...
                    <div className="d-flex switcher-style pb-2">
                      <div className="form-check switch-select me-3">
                        <OverlayTrigger
                          placement="top"
                          overlay={<Tooltip>Default Light Header</Tooltip>}
                        >
                          <input
                            className="form-check-input color-input color-white"
                            type="radio"
                            name="header-colors"
                            checked={
                              local_varaiable.defaultHeaderStyles == "light"
                            }
                            onChange={(_e) => {}}
                            onClick={() =>
                              switcherdata.defaultlightHeader(ThemeChanger)
                            }
                      ...
                      <div className="form-check switch-select me-3">
                        <OverlayTrigger
                          placement="top"
                          overlay={<Tooltip>Default Dark Header</Tooltip>}
                        >
                          <input
                            className="form-check-input color-input color-dark"
                            type="radio"
                            name="header-colors"
                            checked={
                              local_varaiable.defaultHeaderStyles == "dark"
                            }
                            onChange={(_e) => {}}
                            onClick={() =>
                              switcherdata.defaultdarkHeader(ThemeChanger)
                            }
                      ...
                      <div className="form-check switch-select me-3">
                        <OverlayTrigger
                          placement="top"
                          overlay={<Tooltip>Default Color Header</Tooltip>}
                        >
                          <input
                            className="form-check-input color-input color-primary"
                            checked={
                              local_varaiable.defaultHeaderStyles == "color"
                            }
                            onChange={(_e) => {}}
                            onClick={() =>
                              switcherdata.defaultcolorHeader(ThemeChanger)
                            }
                            type="radio"
                            name="header-colors"
                      ...
                      <div className="form-check switch-select me-3">
                        <OverlayTrigger
                          placement="top"
                          overlay={<Tooltip>Default Gradient Header</Tooltip>}
                        >
                          <input
                            className="form-check-input color-input color-gradient"
                            checked={
                              local_varaiable.defaultHeaderStyles == "gradient"
                            }
                            onChange={(_e) => {}}
                            onClick={() =>
                              switcherdata.defaultgradientHeader(ThemeChanger)
                            }
                            type="radio"
                            name="header-colors"
                      ...
                      <div className="form-check switch-select me-3">
                        <OverlayTrigger
                          placement="top"
                          overlay={
                            <Tooltip>Default Transparent Header</Tooltip>
                          }
                        >
                          <input
                            className="form-check-input color-input color-transparent"
                            checked={
                              local_varaiable.defaultHeaderStyles ==
                              "transparent"
                            }
                            onChange={(_e) => {}}
                            onClick={() =>
                              switcherdata.defaulttransparentHeader(
                                ThemeChanger
                              )
                            }
                            type="radio"
                    ...
                    <div className="d-flex flex-wrap align-items-center switcher-style">
                      <div className="form-check switch-select me-3">
                        <input
                          ...
                          type="radio"
                          checked={
                            local_varaiable.colorPrimaryRgb == "13, 73, 159"
                          }
                          onChange={(_e) => {}}
                          onClick={() =>
                      ...
                      <div className="form-check switch-select me-3">
                        <input
                          ...
                          type="radio"
                          checked={
                            local_varaiable.colorPrimaryRgb == "0, 128, 172"
                          }
                          onChange={(_e) => {}}
                          onClick={() =>
                      ...
                      <div className="form-check switch-select me-3">
                        <input
                          ...
                          name="theme-primary"
                          checked={
                            local_varaiable.colorPrimaryRgb == "100, 48, 124"
                          }
                          onChange={(_e) => {}}
                          onClick={() =>
                      ...
                      <div className="form-check switch-select me-3">
                        <input
                          ...
                          name="theme-primary"
                          checked={
                            local_varaiable.colorPrimaryRgb == "5, 154, 114"
                          }
                          onChange={(_e) => {}}
                          onClick={() =>
                      ...
                      <div className="form-check switch-select me-3">
                        <input
                          ...
                          name="theme-primary"
                          checked={
                            local_varaiable.colorPrimaryRgb == "177, 90, 17"
                          }
                          onChange={(_e) => {}}
                          onClick={() =>
