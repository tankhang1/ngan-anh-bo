                    ...
                    <div className="d-flex switcher-style pb-2">
                      ...
                      <div className="form-check switch-select me-3">
                        <input
                          ...
                          data-bs-toggle="tooltip"
                          checked={
                            local_varaiable.defaultHeaderStyles == "transparent"
                          }
                          onChange={(_e) => {}}
                          onClick={() =>
                            switcherdata.defaulttransparentHeader(ThemeChanger)
                          }
                          data-bs-placement="top"
                          title="Default Transparent Header"
                          type="radio"
                          name="header-colors"
