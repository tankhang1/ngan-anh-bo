		...
		<Fragment>
			<Row>
				...
				{/* <Col xl={6}>
                        <Card className="custom-card">
                            <Card.Header>
                                <Card.Title>Pictorial Chart</Card.Title>
                            </Card.Header>
                            <Card.Body>
                                <div id="echart-pictorial" className="echart-charts"></div>
                            </Card.Body>
                        </Card>
                    </Col> */}
			</Row>
