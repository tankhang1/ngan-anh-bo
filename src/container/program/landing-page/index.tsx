...
import { useUploadProgramFileMutation } from "../../../redux/api/media/media.api";
...
import { TPresentLanding } from "../../../assets/types";
          ...
          <AppTable
            ...
            headers={[
              ...
              },
              {
                ...
                render: (row: TPresentLanding) => (
                  <td>
                    <span className="fw-semibold">{row.gift}</span>
                  </td>
                ),
              },
              {
                ...
                render: (row: TPresentLanding) => (
                  <td>
                    <span className="fw-semibold">{row.gift_name}</span>
                  </td>
                ),
              },
              {
                ...
                render: (row: TPresentLanding) => (
                  <td>
                    <span className="fw-semibold">{row.percent}</span>
                  </td>
                ),
              },
              {
                ...
                render: (row: TPresentLanding) => (
                  <td>
                    <span className="fw-semibold">{row.limits}</span>
                  </td>
                ),
              },
              {
                    ...
                    <Dropdown className="ms-2">
                      ...
                      <Dropdown.Menu as="ul" className="dropdown-menu-start">
                        ...
                        <Dropdown.Item
                          ...
                          onClick={async () => {
                            try {
                              await removeLanding({ gift: row.gift }).unwrap();
