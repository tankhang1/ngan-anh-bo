          ...
          <div className="container">
            <div className="row align-items-center justify-content-center mx-2">
              <Col
                ...
                xl={8}
                lg={9}
                className="rectangle error-authentication "
              >
                <div className="text-center authentication-style rectangle1">
                  ...
                  <p className="text-muted fw-normal">
                    ...
                    to access has been removed or never been existed.
                  </p>
                  ...
                  >
                    <IconArrowLeft className=" align-middle me-1 d-inline-block"></IconArrowLeft>
                    BACK TO HOME
                  </Link>
                </div>
              </Col>
