...
function OutstandingReport() {
  ...
  const ListItem = useMemo(
    () => [
      {
        key: "agencyChecked",
        title: "Đại lý đã xác thực",
        value: reportCurrentDay?.agent,
        isLoading: false,
        // isIncrease:
        //   reportCurrentDay?.agent &&
        //   reportPreviousDay?.agent &&
        //   reportCurrentDay?.agent > reportPreviousDay?.agent
        //     ? true
        //     : false,
        // changedValue:
        //   (reportCurrentDay?.agent &&
        //     reportPreviousDay?.agent &&
        //     Math.abs(reportCurrentDay?.agent - reportPreviousDay?.agent)) ||
        //   0,
      },
      {
        key: "agencyUnchecked",
        title: "Đại lý chờ xác thực",
        value: reportCurrentDay?.agent_none,
        isLoading: false,
        // isIncrease:
        //   reportCurrentDay?.agent_none &&
        //   reportPreviousDay?.agent_none &&
        //   reportCurrentDay?.agent_none > reportPreviousDay?.agent_none
        //     ? true
        //     : false,
        // changedValue:
        //   (reportCurrentDay?.agent_none &&
      ...
      {
        key: "farmerChecked",
        title: "Nông dân đã xác thực",
        value: reportCurrentDay?.farmer,
        isLoading: false,
        // isIncrease:
        //   reportCurrentDay?.farmer &&
        //   reportPreviousDay?.farmer &&
        //   reportCurrentDay?.farmer > reportPreviousDay?.farmer
        //     ? true
        //     : false,
        // changedValue:
        //   (reportCurrentDay?.farmer &&
        //     reportPreviousDay?.farmer &&
        //     Math.abs(reportCurrentDay?.farmer - reportPreviousDay?.farmer)) ||
        //   0,
      },
      {
        key: "farmerUnChecked",
        title: "Nông dân chờ xác thực",
        value: reportCurrentDay?.farmer_none,
        isLoading: false,
        // isIncrease:
        //   reportCurrentDay?.farmer_none &&
        //   reportPreviousDay?.farmer_none &&
        //   reportCurrentDay?.farmer_none > reportPreviousDay?.farmer_none
        //     ? true
        //     : false,
        // changedValue:
        //   (reportCurrentDay?.farmer_none &&
      ...
      {
        key: "qrCode",
        title: "Lượt quét QRCode",
        value: reportCurrentDay?.qrcode,
        isLoading: false,
        // isIncrease:
        //   reportCurrentDay?.qrcode &&
        //   reportPreviousDay?.qrcode &&
        //   reportCurrentDay?.qrcode > reportPreviousDay?.qrcode
        //     ? true
        //     : false,
        // changedValue:
        //   (reportCurrentDay?.qrcode &&
        //     reportPreviousDay?.qrcode &&
        //     Math.abs(reportCurrentDay?.qrcode - reportPreviousDay?.qrcode)) ||
        //   0,
      },
      {
        key: "sms",
        title: "Lượt nhắn tin SMS",
        value: reportCurrentDay?.sms,
        isLoading: false,
        // isIncrease:
        //   reportCurrentDay?.sms &&
        //   reportPreviousDay?.sms &&
        //   reportCurrentDay?.sms > reportPreviousDay?.sms
        //     ? true
        //     : false,
        // changedValue:
        //   (reportCurrentDay?.sms &&
        //     reportPreviousDay?.sms &&
        //     Math.abs(reportCurrentDay?.sms - reportPreviousDay?.sms)) ||
        //   0,
      },
      {
        key: "sumSMSBrandName",
        title: "Tổng tin SMS Brandname",
        value: reportCurrentDay?.brandname,
        isLoading: false,
        // isIncrease:
        //   reportCurrentDay?.brandname &&
        //   reportPreviousDay?.brandname &&
        //   reportCurrentDay?.brandname > reportPreviousDay?.brandname
        //     ? true
        //     : false,
        // changedValue:
        //   (reportCurrentDay?.brandname &&
      ...
      {
        key: "topup",
        title: "Tổng lượng Topup",
        value: reportCurrentDay?.topup,
        isLoading: false,
        // isIncrease:
        //   reportCurrentDay?.topup &&
        //   reportPreviousDay?.topup &&
        //   reportCurrentDay?.topup > reportPreviousDay?.topup
        //     ? true
        //     : false,
        // changedValue:
        //   (reportCurrentDay?.topup &&
        //     reportPreviousDay?.topup &&
        //     Math.abs(reportCurrentDay?.topup - reportPreviousDay?.topup)) ||
        //   0,
      },
    ],
    [reportCurrentDay]
