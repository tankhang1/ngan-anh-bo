              ...
              <Card.Body className="p-0">
                ...
                >
                  <Container fluid>
                    ...
                    <Navbar.Collapse
                      className="collapse navbar-collapse navbar-justified"
                    ...
                    >
                      <ul className="navbar-nav me-auto mb-2 mb-lg-0 align-items-xxl-center">
                        ...
                        <Dropdown className="nav-item dropdown d-flex">
                          <Dropdown.Toggle
                            variant=""
                            className="nav-link dropdown-toggle no-carert"
                            href="#"
                            id="navbarDropdown"
                            role="button"
                        ...
                        <div className="ms-3 mt-2 mt-sm-0">
                          ...
                          <div className="mt-2">
                            <Link
                              ...
                              className="btn btn-sm btn-danger-light me-1"
                            >
                            ...
                            <Link
                              ...
                              className="btn btn-sm btn-info-light me-1"
                              onClick={() => {
                                AddToCart(idx.id);
                              }}
                            >
