...
const Landing: FC<LandingProps> = () => {
	...
	const handleClick = (e: { preventDefault: () => void; currentTarget: { getAttribute: (arg0: string) => any; }; }) => {
		e.preventDefault();
	...
	useEffect(() => {
		...
		pageLinks.forEach((elem:any) => {elem.addEventListener("click", handleClick);
		});
    
		return () => {
			// Clean up event listeners when the component unmounts
			pageLinks.forEach((elem:any) => {elem.removeEventListener("click", handleClick);
			});
		};
	}, []);
				...
				<header className="app-header">
					...
					<div className="main-header-container container-fluid">
						...
						<div className="header-content-left">
							...
							<div className="header-element">
								<Link aria-label="anchor" to="#" className="sidemenu-toggle header-link" data-bs-toggle="sidebar" onClick={() =>toggleNavigation()}>
