      ...
      <ul className="main-menu">
        ...
        <li className="slide">
          <a
            href="#testimonials"
            className="side-menu__item"
            onClick={() => handleClick1("testimonials")}
          >
