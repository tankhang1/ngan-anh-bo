...
function IQRWeek() {
  ...
  const { data: bins, isLoading: isLoadingBin } = useGetListBinQuery(
    {
      st: +startDate,
      ed: +endDate,
      nu: 0,
  ...
  const { data: packets, isLoading: isLoadingPacket } = useGetListPackageQuery(
    {
      st: +startDate,
      ed: +endDate,
      nu: 0,
                    ...
                    <button
                      ...
                      onClick={() =>
                        navigate(
                          ...
                          }operator/verify-customer-week/${value.customer_uuid}`
                        )
                      }
                    >
